...
if 'is_logged_in' in st.session_state and st.session_state['is_logged_in']:
    # 로그인된 경우 '여행' 카테고리의 일기 표시
    if 'diaries' in st.session_state and st.session_state.diaries['여행']:
        for entry in reversed(st.session_state.diaries['여행']):
        ...
        st.write("저장된 여행 일기가 없습니다.")
else:
    # 로그인하지 않은 경우
    st.write("로그인 후 여행 카테고리 일기를 볼 수 있습니다.")